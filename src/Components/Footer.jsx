        ...
        <div className="w-auto p-8">
          <a href="#">
            <div className="inline-flex items-center">
              ...
              <span className="ml-4 text-lg font-bold text-white">Umair Yamin</span>
            </div>
          </a>
        </div>
          ...
          <div className="-m-1.5 flex flex-wrap">
            ...
            <div className="w-auto p-1.5">
              <a href="https://instagram.com">
                <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-white-400">
                  <svg
                    width={16}
                    height={15}
                    viewBox="0 0 16 15"
